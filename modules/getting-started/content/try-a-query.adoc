...
[source,sql]
----
include::{samplesdir}/airways-query.adoc[]
----
...
[source,json]
----
include::{samplesdir}/airways-result.adoc[]
----
...
[source,sql]
----
include::{samplesdir}/callsign-query.adoc[]
----
...
[source,json]
----
include::{samplesdir}/callsign-result.adoc[]
----
...
* A [.uicontrol]*Bucket Analysis* panel, at the lower-left.lower-left.lower-left.lower-left.
...
* A [.uicontrol]*Results* panel, at the lower-right.
