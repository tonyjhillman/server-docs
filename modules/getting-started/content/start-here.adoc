...
You also get access to a simple code example;
which is runnable out-of-the-box, and provides immediate insight into how the Couchbase SDK can be used to enrich and extend your applications. 
