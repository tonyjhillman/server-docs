...
You can re-generate he SSL certificate by clicking on btn:[Regenerate], trigger a new SSL certificate with the xref:rest-api:rest-xdcr-data-encrypt.adoc#rest-xdcr-data-encrypt[REST API] or generate a new certificate and save it to a file with the CLI command:
...
== Index Settings for Global and Memory-Optimized Indexes</title>
